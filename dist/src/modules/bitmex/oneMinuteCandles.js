...
let OneMinuteCandleHistoryResolver = class OneMinuteCandleHistoryResolver {
    fetchOneMinuteCandleHistory(start, end, ctx) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let timeframe = "1m";
            newStart = new Date(newStart - 5 * MS_PER_MINUTE);
            newEnd = new Date(newEnd.getTime() + 5 * MS_PER_MINUTE);
...
], OneMinuteCandleHistoryResolver.prototype, "fetchOneMinuteCandleHistory", null);
OneMinuteCandleHistoryResolver = __decorate([
    type_graphql_1.Resolver()
], OneMinuteCandleHistoryResolver);
exports.OneMinuteCandleHistoryResolver = OneMinuteCandleHistoryResolver;
//# sourceMappingURL=oneMinuteCandles.js.map