...
let FiveMinuteCandleHistoryResolver = class FiveMinuteCandleHistoryResolver {
    fetchFiveMinuteCandleHistory(start, end, ctx) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let timeframe = "5m";
            newStart = new Date(newStart - 25 * MS_PER_MINUTE);
            newEnd = new Date(newEnd.getTime() + 25 * MS_PER_MINUTE);
...
], FiveMinuteCandleHistoryResolver.prototype, "fetchFiveMinuteCandleHistory", null);
FiveMinuteCandleHistoryResolver = __decorate([
    type_graphql_1.Resolver()
], FiveMinuteCandleHistoryResolver);
exports.FiveMinuteCandleHistoryResolver = FiveMinuteCandleHistoryResolver;
//# sourceMappingURL=fiveMinuteCandles.js.map