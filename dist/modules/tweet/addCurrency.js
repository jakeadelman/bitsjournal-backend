...
let AddCurrencyResolver = class AddCurrencyResolver {
    addCurrency(currencyName, ticker, ctx) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let newCurrency = new Currency_1.Currency();
...
__decorate([
    ...
    __param(0, type_graphql_1.Arg("currencyName")),
    __param(1, type_graphql_1.Arg("ticker")),
    __param(2, type_graphql_1.Ctx()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, Object]),
    __metadata("design:returntype", Promise)
], AddCurrencyResolver.prototype, "addCurrency", null);
AddCurrencyResolver = __decorate([
    type_graphql_1.Resolver()
], AddCurrencyResolver);
exports.AddCurrencyResolver = AddCurrencyResolver;
