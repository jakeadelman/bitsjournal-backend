...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Funding', 'model/Error'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Funding'), require('../model/Error'));
  } else {
    // Browser globals (root is window)
    if (!root.BitMexApi) {
      root.BitMexApi = {};
    }
    root.BitMexApi.FundingApi = factory(root.BitMexApi.ApiClient, root.BitMexApi.Funding, root.BitMexApi.Error);
  }
}(this, function(ApiClient, Funding, Error) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the fundingGet operation.
     * @callback module:api/FundingApi~fundingGetCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/Funding>} data The data returned by the service call.
     ...
     * @param {module:api/FundingApi~fundingGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {Array.<module:model/Funding>}
     */
    this.fundingGet = function(opts, callback) {
      opts = opts || {};
      var postBody = null;
