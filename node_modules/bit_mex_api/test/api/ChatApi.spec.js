  ...
  describe('ChatApi', function() {
    describe('chatGet', function() {
      it('should call chatGet successfully', function(done) {
        //uncomment below and update the code to test chatGet
        //instance.chatGet(pet, function(error) {
    ...
    describe('chatGetConnected', function() {
      it('should call chatGetConnected successfully', function(done) {
        //uncomment below and update the code to test chatGetConnected
        //instance.chatGetConnected(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('chatNew', function() {
      it('should call chatNew successfully', function(done) {
        //uncomment below and update the code to test chatNew
        //instance.chatNew(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
