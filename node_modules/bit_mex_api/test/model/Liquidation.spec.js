...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BitMexApi.Liquidation();
  });
  ...
  describe('Liquidation', function() {
    it('should create an instance of Liquidation', function() {
      // uncomment below and update the code to test Liquidation
      //var instane = new BitMexApi.Liquidation();
      //expect(instance).to.be.a(BitMexApi.Liquidation);
    });
