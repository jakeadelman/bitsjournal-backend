...
(function(root, factory) {
  ...
  describe('Chat', function() {
    it('should create an instance of Chat', function() {
      ...
      //var instane = new BitMexApi.Chat();
    ...
    it('should have the property fromBot (base name: "fromBot")', function() {
      // uncomment below and update the code to test the property fromBot
      //var instane = new BitMexApi.Chat();
      //expect(instance).to.be();
    });
